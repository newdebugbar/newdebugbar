@php
    ...
    $queueItems = $inspector['payload']['records'] ?? [];
    ...
    $totalDuration = (float) ($inspector['summary']['duration_ms'] ?? 0);
    $failureCount = (int) ($inspector['summary']['failed_count'] ?? 0);
            ...
            >
                ...
                <template x-if="selectedQueueActivity">
                    <div class="ndb:flex ndb:flex-col">
                                    ...
                                    <x-newdebugbar::inspector-action
                                        ...
                                        @click="
                                            inspector.openRelatedProfile(
                                                ...
                                                selectedQueueActivity.related_inspector,
                                            )
                                        "
                        ...
                        @include('newdebugbar::livewire.inspectors.queue.attempts')
                    </div>
                </template>
