...
test('authorization controls filter search selection detail and inspector navigation', () => {
  ...
  state.$refs = {
    ...
    inspectorHeading: { focus: () => headingFocused++ },
  };
  ...
  state.init();
  shell.navigateToInspector('authorization', 'denied');
