...
it('keeps a queued notification pending until its worker runs', function () {
    visit('/profiled-queued-communications')
        ...
        ->click('[data-ndb-select-inspector="notifications"]')
...
it('groups notification attempts in a full-height delivery inspector', function () {
    $page = visit('/profiled-notifications-rich')
        ...
        ->assertScript('document.querySelector("[data-ndb-select-inspector=notifications]").textContent.trim().endsWith("2")')
        ...
        ->assertScript(<<<'JS'
            (() => {
                ...
                const loadedInspector = document.querySelector('[data-ndb-loaded-inspector="notifications"]');
                ...
                return getComputedStyle(workspace).display === 'grid'
                    ...
                    && getComputedStyle(loadedInspector).paddingLeft === '0px'
